...
@Component({
  selector: 'app-drawing-recognition',
  templateUrl: './drawing-recognition.component.html',
  styleUrls: ['./drawing-recognition.component.scss']
})
export class DrawingRecognitionComponent implements OnInit {
